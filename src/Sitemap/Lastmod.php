 ...
 */
final class Lastmod extends Abstract_Validator
{
     ...
     */
    protected array $message_templates = [self::NOT_VALID => 'The input is not a valid sitemap lastmod', self::INVALID => 'Invalid type given. String expected'];
    /**
