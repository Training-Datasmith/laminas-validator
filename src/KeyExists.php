 ...
 * }
 */
final class Key_Exists extends Abstract_Validator
{
    ...
    protected array $message_variables = ['key' => 'key', 'type' => 'type'];
    /**
     * Validation failure message template definitions
     *
     * @var array<string, string>
     */
    protected array $message_templates = [self::ERR_NOT_ITERABLE => 'Invalid type given. Expected iterable but %type% received.', self::ERR_KEY_NOT_FOUND => 'The key %key% was not found in the iterable.'];
