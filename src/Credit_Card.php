 ...
 * }
 */
final class Credit_Card extends Abstract_Validator
{
    /**
     * Detected CCI list
     */
    ...
    private const TYPES = [self::AMERICAN_EXPRESS, self::DINERS_CLUB, self::DINERS_CLUB_US, self::DISCOVER, self::JCB, self::LASER, self::MAESTRO, self::MASTERCARD, self::SOLO, self::UNIONPAY, self::VISA, self::MIR];
    private const CARD_LENGTH = [self::AMERICAN_EXPRESS => [15], self::DINERS_CLUB => [14], self::DINERS_CLUB_US => [16], self::DISCOVER => [16, 19], self::JCB => [15, 16], self::LASER => [16, 17, 18, 19], self::MAESTRO => [12, 13, 14, 15, 16, 17, 18, 19], self::MASTERCARD => [16], self::SOLO => [16, 18, 19], self::UNIONPAY => [16, 17, 18, 19], self::VISA => [13, 16, 19], self::MIR => [13, 16]];
    private const CARD_PREFIXES = [self::AMERICAN_EXPRESS => ['34', '37'], self::DINERS_CLUB => ['300', '301', '302', '303', '304', '305', '36'], self::DINERS_CLUB_US => ['54', '55'], self::DISCOVER => ['6011', '622126', '622127', '622128', '622129', '62213', '62214', '62215', '62216', '62217', '62218', '62219', '6222', '6223', '6224', '6225', '6226', '6227', '6228', '62290', '62291', '622920', '622921', '622922', '622923', '622924', '622925', '644', '645', '646', '647', '648', '649', '65'], self::JCB => ['1800', '2131', '3528', '3529', '353', '354', '355', '356', '357', '358'], self::LASER => ['6304', '6706', '6771', '6709'], self::MAESTRO => ['5018', '5020', '5038', '6304', '6759', '6761', '6762', '6763', '6764', '6765', '6766', '6772'], self::MASTERCARD => ['2221', '2222', '2223', '2224', '2225', '2226', '2227', '2228', '2229', '223', '224', '225', '226', '227', '228', '229', '23', '24', '25', '26', '271', '2720', '51', '52', '53', '54', '55'], self::SOLO => ['6334', '6767'], self::UNIONPAY => ['622126', '622127', '622128', '622129', '62213', '62214', '62215', '62216', '62217', '62218', '62219', '6222', '6223', '6224', '6225', '6226', '6227', '6228', '62290', '62291', '622920', '622921', '622922', '622923', '622924', '622925'], self::VISA => ['4'], self::MIR => ['2200', '2201', '2202', '2203', '2204']];
    /**
    ...
    public function __construct(array $options = [])
    {
        ...
        if (is_callable($service)) {
            $this->callback = new Callback(['callback' => $service, 'callbackOptions' => [$this->type], 'throwExceptions' => true]);
        } else {
            $this->callback = null;
        }
     ...
     */
    private function resolve_type(string|array $types): array
    {
        if (is_string($types)) {
            $types = [$types];
        }
        ...
        foreach ($types as $type) {
            ...
            if (defined($constant)) {
                $value = $this->is_valid_type(constant($constant));
                if ($value !== null) {
                    $list[] = $value;
                }
            }
     ...
     */
    private function is_valid_type(mixed $type): ?string
    {
    ...
    ): bool
    {
        ...
        if ($this->callback !== null) {
            try {
                if (!$this->callback->is_valid($value, $context)) {
