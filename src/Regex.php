 ...
 * }
 */
final class Regex extends Abstract_Validator
{
    public const INVALID = 'regexInvalid';
    public const NOT_MATCH = 'regexNotMatch';
    /** @var array<string, string> */
    protected array $message_templates = [self::INVALID => 'Invalid type given. String, integer or float expected', self::NOT_MATCH => "The input does not match against pattern '%pattern%'"];
    /** @var array<string, string|array<string, string>> */
    protected array $message_variables = ['pattern' => 'pattern'];
    /**
