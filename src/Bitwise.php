 ...
 * }
 */
final class Bitwise extends Abstract_Validator
{
     ...
     */
    protected array $message_templates = [self::NOT_AND => "The input has no common bit set with '%control%'", self::NOT_AND_STRICT => "The input doesn't have the same bits set as '%control%'", self::NOT_XOR => "The input has common bit set with '%control%'", self::NO_OP => "No operator was present to compare '%control%' against", self::NOT_INTEGER => "Expected an integer to compare '%control%' against"];
    /** @var array<string, string|array<string, string>> */
    protected array $message_variables = ['control' => 'control'];
